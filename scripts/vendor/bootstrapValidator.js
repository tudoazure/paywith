...
(function ($) {
    $.fn.bootstrapValidator.validators.uploadFile = {
...
(function ($) {
    $.fn.bootstrapValidator.validators.validFileSize = {
        ...
        validate: function (validator, $field, options) {
            ...
            if (($field[0].files[0].size / 1048576) > options.maxSize) {
                return false;
            }
            return true;
        }
